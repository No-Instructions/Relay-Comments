// Vendored from Relay so this plugin builds without a checkout of it.
// Source: relay-plugin-api.d.ts at No-Instructions/Relay.
...
declare module "obsidian" {
	interface Workspace {
		// Preserve Events.trigger for workspace events outside Relay. Declaring
		// literal trigger overloads on Workspace otherwise hides the inherited
		// generic signature from consumers.
